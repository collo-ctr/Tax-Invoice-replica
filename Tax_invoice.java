public class Tax_invoice {
    public static void main(String[] args) {
        ...
        System.out.println("------------------------------------------------------------------------------------------------------------");
        System.out.println("                                                                                                            ");
        System.out.println("    C026-01-2574/2024                                Mung'atia Collins Mugendi");
        ...
        System.out.println("    GSTIN:33AAPSPFD71V                               GSTIN:33AAPSPFD71V");
        System.out.println("    Contact: +91-7689825463                          Contact: +91-7689825463");
